...
- **Background & Motivation:** NFT is getting more and more popular, but the amount of research related to the prediction of the value a NFT product is still small. This project focus on the research question that what are the hot topics in the NFT prediction field. This question is important since it can help further research find new attributes in prediction. This project is applied to eight literatures related to the NFT prediction topic. The machine learning methodology explanation is used in this project, especially, word cload and bigram are used for text analysis. The results shows some new high-frequency words and new relationship of keywords. This project contributes to the future research direction of NFT prediction. More research can be conducted based on the new high-frequency words.
